...
description: Как партнёры, технические команды клиентов и ИИ-агенты могут использовать One Link integration skills в Codex и Claude Code.
sidebarTitle: Agent Skills
---

# Agent Skills для интеграторов

Для внешних API-потребителей подготовлен отдельный skill bundle `onelink-integrator`.
...
Группы технических клиентов и партнёры могут установить внешний bundle для Codex или Claude Code.

Оба варианта предназначены для API-потребителей и агентов, которые действуют от их имени. Они помогают:
