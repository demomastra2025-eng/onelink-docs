...
description: Operational deployment guide for the Onelink fork, based on inherited Chatwoot deployment and self-hosted documentation.
sidebarTitle: Overview
---

This section contains the operational deployment and infrastructure guidance used to run the Onelink fork.

Most of the detailed pages in this area are inherited from Chatwoot and remain relevant as the infrastructure base for Onelink deployments.
...
Onelink currently inherits the same broad deployment paths as Chatwoot:
...
Before starting an Onelink deployment, ensure you have:
