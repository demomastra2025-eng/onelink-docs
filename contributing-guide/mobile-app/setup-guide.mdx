...
description: Setup guide for mobile app development on top of the Onelink fork
...
| EXPO_PUBLIC_CHATWOOT_BASE_URL            | Self-hosted installation URL                | https://one-link.kz | Yes      |
...
If you are using the community edition of Chatwoot with the [official mobile app](https://one-link.kz/mobile-apps), push notifications work out of the box with no additional configuration.
