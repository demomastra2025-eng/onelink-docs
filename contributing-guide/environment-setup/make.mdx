...
description: Speed up your local development workflow with Make commands for OneLink.
...
## Clone the repo and `cd` into the OneLink directory
...
## Workflow after pulling in the latest changes from `onelink-main`
