...
Use dedicated sync branches when bringing Chatwoot changes into the fork. Do not treat `develop` in this fork as the product base branch.
...
- use `sync/...` branches only for Chatwoot upstream intake
