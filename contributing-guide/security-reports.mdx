...
description: How to report security vulnerabilities in the Onelink fork
sidebarTitle: Security Reports
---

# Reporting Security Issues

We want to work with security researchers to keep the Onelink fork and its users safe. If you have found an issue in our systems or applications, please reach out through the responsible disclosure path below.
...
<Warning>
Please do not perform testing against production services. Use a self-hosted or isolated fork instance to perform tests.
</Warning>
...
- **Process Questions**: Contact security@one-link.kz
