---
title: Translate Onelink to Your Language
description: Guide to translating the fork using the Crowdin translation platform
sidebarTitle: Translation Guidelines
---

# Translate OneLink to Your Language
...
You can login to **Crowdin** ([https://one-link.kz](https://one-link.kz)) and create an account to view the strings that need to be translated.
...
The translation process for Chatwoot web and mobile app is managed at [https://one-link.kz](https://one-link.kz) using Crowdin. You will have to create an account at Crowdin before you can select a language and contribute.
...
You can check the translation progress for different languages on our [Crowdin project page](https://one-link.kz). This shows:
...
Ready to help make Chatwoot accessible to users worldwide? [Start translating today](https://one-link.kz)! 🌍 
