...
description: Complete guide to setting up and running the Onelink fork in development mode
sidebarTitle: Setup Guide
---

# Project Setup

This guide will help you set up and run the Onelink fork in development mode. Please make sure you have completed the environment setup.
...
This would install all required dependencies for the forked application.
...
When running the fork in development, the chat widget can be accessed under the following URL.
