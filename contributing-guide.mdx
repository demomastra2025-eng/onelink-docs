...
OneLink is built on top of an upstream base product, but active product development should follow OneLink's own architecture direction, branching workflow, and domain boundaries.
