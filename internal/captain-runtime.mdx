...
- capability tools exposed in assistant settings (`faq_lookup`, `handoff`, contact note, private note) are controlled by their checkboxes, not by the agent permissioned-tool runtime list
