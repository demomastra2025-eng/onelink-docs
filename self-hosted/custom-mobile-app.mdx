...
description: Guide to building a custom-branded mobile app on top of the Onelink/Chatwoot fork with push notifications and deep linking
...
<Note>
You must use either the official apps for both platforms or custom builds for both — mixing is not supported. For more details, refer to the [push notification documentation](https://one-link.kz/hc/handbook/articles/1687935909-push-notification).
</Note>
