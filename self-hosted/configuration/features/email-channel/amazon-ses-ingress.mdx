---
title: Configuring Amazon SES as an Ingress Provider
...
### Step 4: Configure OneLink environment variables
...
### Step 5: Create an SNS subscription to forward to OneLink
...
### Step 6: Add the email channel in OneLink
