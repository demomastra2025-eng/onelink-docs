...
description: Overview of email channel configuration for the self-hosted Onelink fork
...
### Forwarding Rule (Email → OneLink Ingress)
...
### IMAP (Inbound Only) + OneLink Mailer (Outbound)
