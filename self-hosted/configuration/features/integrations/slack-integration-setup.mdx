...
description: Configure Slack integration to receive product conversations in Slack channels from the Onelink fork
sidebarTitle: Slack
---
...
## Configure the environment variables in OneLink
...
## Connect OneLink with your Slack workspace

Follow this [guide](https://one-link.kz/hc/user-guide/articles/1677774874-how-to-answer-conversations-from-slack) to complete the Slack integration.
