...
## Create the Instagram inbox in OneLink

1. Head over to Chatwoot and create a Messenger inbox. Please refer to this [guide](https://one-link.kz/hc/user-guide/articles/1677829420-how-to-setup-an-instagram-channel) for more details on creating a Messenger inbox in Chatwoot.
...
1. After finishing the setup above, [create a Messenger inbox](https://one-link.kz/hc/user-guide/articles/1677778588-how-to-setup-a-facebook-channel) after logging in to your Chatwoot Installation.
