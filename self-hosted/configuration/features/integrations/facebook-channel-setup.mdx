...
description: Configure Facebook Messenger integration for the Onelink fork
...
## Configuring the environment variables in OneLink
...
5. Head over to Chatwoot and create a Messenger inbox. Choose a page for which your Facebook developer account has admin access to. Please refer to this [guide](https://one-link.kz/hc/user-guide/articles/1677778588-how-to-setup-a-facebook-channel) for more details on creating a Messenger inbox in Chatwoot.
...
1. After finishing the set-up above, [create a Facebook inbox](https://one-link.kz/hc/user-guide/articles/1677778588-how-to-setup-a-facebook-channel) after logging in to your Chatwoot Installation.
