...
### Create a portal in the OneLink dashboard

Follow these step to create your Portal. Refer to [this guide.](https://one-link.kz/hc/user-guide/articles/1677861202-how-to-setup-a-help-center)

### Point your custom domain to your OneLink domain
