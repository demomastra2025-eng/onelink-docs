...
description: Deploy the Onelink fork on a single droplet in DigitalOcean
...
2. Follow the linux VM instructions at https://one-link.kz/docs/self-hosted/deployment/linux-vm.
3. Onelink is ready and can be accessed at `http://<your-droplet-ip>:3000`. Or if you completed the domain setup during the installation, Onelink should be available at `https://<your-domain>`

## Configure Chatwoot

1. Follow the Chatwoot docs to configure your domain, email and other parameters you need.
https://one-link.kz/docs/self-hosted/deployment/linux-vm#configure-the-required-environment-variables 
