...
description: Deploy OneLink on Ubuntu 24.04 LTS using the automated installation script
...
```bash
# Login as the OneLink user
sudo -i -u chatwoot

# Navigate to the OneLink directory
cd chatwoot
...
## Install or Upgrade the OneLink CLI
