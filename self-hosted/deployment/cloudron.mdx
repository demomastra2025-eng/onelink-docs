---
title: Cloudron deployment guide
description: Deploy the Onelink fork using Cloudron's 1-click app platform
...
## Upgrading a OneLink installation

Chatwoot follows a monthly release pattern with a new release every 15th of the month. Use the built in [Cloudron app updates](https://docs.cloudron.io/updates/) to stay on the latest version. Read about the changelog [here](https://one-link.kz/changelog/).
