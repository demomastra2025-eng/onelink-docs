---
title: Restack production deployment guide
description: Deploy the Onelink fork on AWS with Restack's managed Kubernetes platform
...
## Deploy multiple instances of OneLink
