...
description: Deploy the Onelink fork on AWS using the marketplace AMI listing
sidebarTitle: AWS Marketplace
---

# AWS OneLink Deployment Guide
...
## Install OneLink via AWS Marketplace AMI

### Step 1: Subscribe to OneLink
...
### Step 12: Access OneLink

12. Visit `http://<your-public-ip>:3000`. This should bring up the Onelink UI. Congratulations.
