...
description: Deploy the Onelink fork on a single VM in Azure
sidebarTitle: Azure
---
...
3. Onelink is ready and can be accessed at `http://<your-instance-ip>:3000`. Or if you completed the domain setup during the installation, Onelink should be available at `https://<your-domain>`.
