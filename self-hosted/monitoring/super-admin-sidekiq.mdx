...
description: Guide to accessing and using the Super Admin Console and Sidekiq monitoring in the Onelink fork
...
Run the following command in your console from the root folder of the Rails app.
