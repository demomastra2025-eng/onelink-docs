---
title: Rate Limiting
description: Configure rate limiting to protect your Onelink installation from abuse
sidebarTitle: Rate Limiting
---

To protect the system from abusive requests, the fork makes use of [`rack_attack`](https://github.com/rack/rack-attack).
...
- The application throttles requests by IP at `60rpm`, unless the request is from an allowed IP `['127.0.0.1', '::1']`
