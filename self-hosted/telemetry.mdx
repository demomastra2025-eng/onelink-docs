---
title: "Telemetry"
description: "Learn about telemetry data collection in the Onelink fork, what data is collected, how it's used, and how to opt-out"
---

The fork may track usage of product features to help improve the software. You can opt-out of this telemetry where the installation supports it.

## What data is collected

None of your customer data is ever transmitted by the installation. The telemetry data collected by the product is purely usage statistics of various software features.
