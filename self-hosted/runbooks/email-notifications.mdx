---
title: Customize email notifications in Onelink
description: Guide to customizing email notification templates in self-hosted Onelink installations
sidebarTitle: Email Notifications
---

The fork allows customization of email notifications in self-hosted installations.
