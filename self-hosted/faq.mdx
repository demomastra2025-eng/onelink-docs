...
description: 'Common questions and answers about self-hosted Onelink installation, support, and best practices'
---

This document is a place to search for frequently asked questions about operating the Onelink fork, support expectations, and best practices.
...
| [Email](mailto:hello@one-link.kz) | Responses in 2 Business Days or as per SLA | Business Enquiries, Premium Support |
...
## How to promote OneLink services?
...
## How can I customize the OneLink branding?

Upstream Chatwoot distinguishes between Community and Enterprise editions for branding-related capabilities.

In the current Onelink fork, inherited enterprise capabilities are opened for the project by default, so treat branding availability as fork-specific product behavior rather than as an active Community-vs-Enterprise boundary.

## Can I run a SaaS using OneLink?

Ref: [Are there any restrictions in using Chatwoot?](#are-there-any-restrictions-on-using-chatwoot)

## Are there any restrictions on using OneLink?

Upstream Chatwoot still has Community-vs-Enterprise licensing distinctions. Onelink, however, currently treats the inherited `enterprise/` layer as a technical implementation split with enterprise capabilities opened for the project by default.

If you plan to distribute or commercialize this fork, document and verify the fork-specific licensing/commercial rules separately rather than assuming the upstream Chatwoot Community-vs-Enterprise boundary is the current Onelink product model.
...
## How to debug SMTP email errors in OneLink?
...
## How to fix the onboarding screen issue in OneLink?
