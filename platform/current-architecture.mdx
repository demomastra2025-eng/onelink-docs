...
- `VueUse` already active as the shared frontend utility layer through `@vueuse/core` and `@vueuse/components`
...
- the versioned project skill source under `onelink/.codex/skills`
