...
Onelink currently operates across three local knowledge and change surfaces:
...
3. `$CODEX_HOME/skills`
   - the local Codex skill library used to guide AI agents in this workspace
...
- Codex skill definitions belong to `$CODEX_HOME/skills`
...
5. the relevant specialized skill in `$CODEX_HOME/skills`
